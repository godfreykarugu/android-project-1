...
import net.ezra.ui.cars.CarDetailScreen
import net.ezra.ui.cars.CarListScreen
import net.ezra.ui.cars.InsertCarScreen
...
fun AppNavHost(
    ...
    NavHost(
        ...
        composable(ROUTE_INSERT_CARS) {
            InsertCarScreen(navController = navController) {
                
            }
        }

        composable(ROUTE_VIEW_CARS){
            CarListScreen(navController = navController,cars = listOf() )
        }
